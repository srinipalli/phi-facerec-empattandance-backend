    ...
    function initKioskMode() {
        ...
        function startRecognition() {
            ...
            recognitionInterval = setInterval(() => {
                ...
                try {
                    ...
                    .catch(error => handleRecognitionError(error, recognitionStatus, loginMessage))
                    .finally(() => {
                        isProcessing = false;
                    });
                } catch (error) {
        ...
        function handleRecognitionSuccess(data, isPunchIn, recognitionStatus, userInfoSection, initialMessage) {
            if (data.success) {
                ...
                showMessage(loginMessage, data.message || 'Recognition failed', 'warning');
            }
        }

        function handleRecognitionError(error, recognitionStatus, loginMessage) {
            recognitionStatus.innerHTML = '<span class="text-danger">Recognition error</span>';
            showMessage(loginMessage, error.message || 'Recognition service unavailable', 'danger');
        }
