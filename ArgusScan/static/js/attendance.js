document.addEventListener('DOMContentLoaded', function() {
    const attendanceApp = {
        ...
        setupSelectAll: function() {
            ...
            if (selectAllCheckbox) {
                selectAllCheckbox.addEventListener('change', (event) => {
                    ...
                    document.querySelectorAll('.attendance-table tbody tr:not([style*="display: none"]) .attendance-checkbox').forEach(checkbox => {
            ...
            if (selectAllBtn) {
                selectAllBtn.addEventListener('click', () => {
                    ...
                    document.querySelectorAll('.attendance-table tbody tr:not([style*="display: none"])').forEach(row => {
        ...
        setupClearSelection: function() {
            ...
            if (clearSelectionBtn) {
                clearSelectionBtn.addEventListener('click', () => {
                    ...
                    document.querySelectorAll('.attendance-table tbody .attendance-checkbox').forEach(checkbox => {
        ...
        updateRegularizeButton: function() {
            ...
            const visibleCheckboxes = document.querySelectorAll('.attendance-table tbody tr:not([style*="display: none"]) .attendance-checkbox');
            const checkedCheckboxes = document.querySelectorAll('.attendance-table tbody tr:not([style*="display: none"]) .attendance-checkbox:checked');
                        ...
                        if (row) {
                            ...
                            const newRow = `
                                <tr data-date="${date}">
                                    ...
                                    <td>${shiftIn}</td>
                                    <td>${shiftOut}</td>
                                    <td><input type="time" class="form-control form-control-sm modify-in" value="${shiftIn}"></td>
                                    <td><input type="time" class="form-control form-control-sm modify-out" value="${shiftOut}"></td>
                                    <td>
